            ...
            <div class="card-body">
                <form action="{{ route('products.store') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('requirements') is-invalid @enderror" id="requirements" name="requirements">{{ old('requirements') }}</textarea>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('company_details') is-invalid @enderror" id="company_details" name="company_details">{{ old('company_details') }}</textarea>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('vacancy') is-invalid @enderror" id="vacancy" name="vacancy">{{ old('vacancy') }}</textarea>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('job_type') is-invalid @enderror" id="job_type" name="job_type">{{ old('job_type') }}</textarea>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('salary') is-invalid @enderror" id="salary" name="salary">{{ old('salary') }}</textarea>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control @error('location') is-invalid @enderror" id="location" name="location">{{ old('location') }}</textarea>
